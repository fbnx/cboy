...
inline void push(uint16_t value) {
    gameboy::mmu::write(cpu.stack_pointer - 1, value >> 8);
    gameboy::mmu::write(cpu.stack_pointer - 2, value & 0xFF);
    cpu.stack_pointer -= 2;
}

inline uint16_t pop() {
    uint16_t value = (gameboy::mmu::read(cpu.stack_pointer + 1) << 8 | gameboy::mmu::read(cpu.stack_pointer)) & 0xFFFF;
    cpu.stack_pointer += 2;
    return value;
}

inline void jr(uint8_t value) {
...
inline uint16_t add_hl(uint16_t a, uint16_t b) {
...
inline uint8_t sbc(uint8_t a, uint8_t b) {
    uint8_t res = (a - b - cpu.flag_C()) & 0xFF;
    cpu.set_flag_Z(res == 0);
    cpu.set_flag_N(true);
...
inline uint8_t and_(uint8_t a, uint8_t b) {
    uint8_t res = a & b;
    cpu.set_flag_Z(res == 0);
    cpu.set_flag_N(false);
    cpu.set_flag_H(true);
...
inline uint8_t or_(uint8_t a, uint8_t b) {
    uint8_t res = a | b;
    cpu.set_flag_Z(res == 0);
    cpu.set_flag_N(false);
...
inline uint8_t xor_(uint8_t a, uint8_t b) {
    uint8_t res = a ^ b;
    cpu.set_flag_Z(res == 0);
    cpu.set_flag_N(false);
    cpu.set_flag_H(false);
...
inline uint8_t cp(uint8_t a, uint8_t b) {
    uint8_t res = a - b;
    cpu.set_flag_Z(res == 0);
    cpu.set_flag_N(true);
    cpu.set_flag_H((a & 0xF) < (b & 0xF));
...
uint8_t execute(uint8_t opcode) {
    switch (opcode) {
        ...
        case 0x01: { // LD BC,d16
            uint8_t low = gameboy::mmu::read(cpu.program_counter++);
            uint8_t high = gameboy::mmu::read(cpu.program_counter++);
            cpu.set_BC((high << 8) | low);
            return 12;
        }
        case 0x02: { // LD (BC),A
            gameboy::mmu::write(cpu.BC(), cpu.registers.A);
            return 8;
        }
        case 0x03: { // INC BC
            cpu.set_BC(cpu.BC() + 1);
        ...
        case 0x06: { // LD B,d8
            cpu.registers.B = gameboy::mmu::read(cpu.program_counter++);
            return 8;
        }
        case 0x07: { // RLCA
        ...
        case 0x08: { // LD (a16),SP
            ...
            gameboy::mmu::write(addr, cpu.stack_pointer & 0xFF);
            gameboy::mmu::write(addr + 1, cpu.stack_pointer >> 8 & 0xFF);
            return 20;
        }
        case 0x09: { // ADD HL,BC
        ...
        case 0x0A: { // LD A,(BC)
            cpu.registers.A = gameboy::mmu::read(cpu.BC());
            return 8;
        }
        case 0x0B: { // DEC BC
            cpu.set_BC(cpu.BC() - 1);
        ...
        case 0x0E: { // LD C,d8
            cpu.registers.C = gameboy::mmu::read(cpu.program_counter++);
            return 8;
        }
        case 0x0F: { // RRCA
        ...
        // 0x10
        case 0x10: { // STOP
            gameboy::mmu::read(cpu.program_counter++); // Consume next byte
            return 4;
        }
        case 0x11: { // LD DE,d16
            uint8_t low = gameboy::mmu::read(cpu.program_counter++);
            uint8_t high = gameboy::mmu::read(cpu.program_counter++);
            cpu.set_DE((high << 8) | low);
            return 12;
        }
        case 0x12: { // LD (DE),A
            gameboy::mmu::write(cpu.DE(), cpu.registers.A);
            return 8;
        }
        case 0x13: { // INC DE
            cpu.set_DE(cpu.DE() + 1);
        ...
        case 0x16: { // LD D,d8
            cpu.registers.D = gameboy::mmu::read(cpu.program_counter++);
            return 8;
        }
        case 0x17: { // RLA
            bool c = (cpu.registers.A >> 7) & 1;
        ...
        case 0x18: { // JR r8
            uint8_t val = gameboy::mmu::read(cpu.program_counter++);
            jr(val);
            return 12;
        }
        case 0x19: { // ADD HL,DE
        ...
        case 0x1A: { // LD A,(DE)
            cpu.registers.A = gameboy::mmu::read(cpu.DE());
            return 8;
        }
        case 0x1B: { // DEC DE
            cpu.set_DE(cpu.DE() - 1);
        ...
        case 0x1E: { // LD E,d8
            cpu.registers.E = gameboy::mmu::read(cpu.program_counter++);
            return 8;
        }
        case 0x1F: { // RRA
        ...
        case 0x21: { // LD HL,d16
            uint8_t low = gameboy::mmu::read(cpu.program_counter++);
            uint8_t high = gameboy::mmu::read(cpu.program_counter++);
            cpu.set_HL((high << 8) | low);
            return 12;
        }
        case 0x22: { // LDI (HL),A
            gameboy::mmu::write(cpu.HL(), cpu.registers.A);
        ...
        case 0x26: { // LD H,d8
            cpu.registers.H = gameboy::mmu::read(cpu.program_counter++);
            return 8;
        }
        case 0x27: { // DAA
        ...
        case 0x2A: { // LDI A,(HL)
            cpu.registers.A = gameboy::mmu::read(cpu.HL());
            cpu.set_HL((cpu.HL() + 1) & 0xFFFF);
            return 8;
        }
        case 0x2B: { // DEC HL
        ...
        case 0x2E: { // LD L,d8
            cpu.registers.L = gameboy::mmu::read(cpu.program_counter++);
            return 8;
        }
        case 0x2F: { // CPL
        ...
        case 0x34: { // INC (HL)
            gameboy::mmu::write(cpu.HL(), inc(gameboy::mmu::read(cpu.HL())));
            return 12;
        }
        case 0x35: { // DEC (HL)
            gameboy::mmu::write(cpu.HL(), dec(gameboy::mmu::read(cpu.HL())));
            return 12;
        }
        case 0x36: { // LD (HL),d8
            gameboy::mmu::write(cpu.HL(), gameboy::mmu::read(cpu.program_counter++));
            return 12;
        }
        case 0x37: { // SCF
            cpu.set_flag_C(true);
        ...
        case 0x3E: { // LD A,d8
            cpu.registers.A = gameboy::mmu::read(cpu.program_counter++);
            return 8;
        }
        case 0x3F: { // CCF
        ...
        case 0x46: { // LD B,(HL)
            cpu.registers.B = gameboy::mmu::read(cpu.HL());
            return 8;
        }
        case 0x47: { // LD B,A
        ...
        case 0x4E: { // LD C,(HL)
            cpu.registers.C = gameboy::mmu::read(cpu.HL());
            return 8;
        }
        case 0x4F: { // LD C,A
        ...
        case 0x56: { // LD D,(HL)
            cpu.registers.D = gameboy::mmu::read(cpu.HL());
            return 8;
        }
        case 0x57: { // LD D,A
        ...
        case 0x5E: { // LD E,(HL)
            cpu.registers.E = gameboy::mmu::read(cpu.HL());
            return 8;
        }
        case 0x5F: { // LD E,A
        ...
        case 0x66: { // LD H,(HL)
            cpu.registers.H = gameboy::mmu::read(cpu.HL());
            return 8;
        }
        case 0x67: { // LD H,A
        ...
        case 0x6E: { // LD L,(HL)
            cpu.registers.L = gameboy::mmu::read(cpu.HL());
            return 8;
        }
        case 0x6F: { // LD L,A
        ...
        // 0x70
        case 0x70: { // LD (HL),B
            gameboy::mmu::write(cpu.HL(), cpu.registers.B);
            return 8;
        }
        case 0x71: { // LD (HL),C
            gameboy::mmu::write(cpu.HL(), cpu.registers.C);
            return 8;
        }
        case 0x72: { // LD (HL),D
            gameboy::mmu::write(cpu.HL(), cpu.registers.D);
            return 8;
        }
        case 0x73: { // LD (HL),E
            gameboy::mmu::write(cpu.HL(), cpu.registers.E);
            return 8;
        }
        case 0x74: { // LD (HL),H
            gameboy::mmu::write(cpu.HL(), cpu.registers.H);
            return 8;
        }
        case 0x75: { // LD (HL),L
            gameboy::mmu::write(cpu.HL(), cpu.registers.L);
            return 8;
        }
        case 0x76: { // HALT
            cpu.halt = true;
        ...
        case 0x86: { // ADD A,(HL)
            cpu.registers.A = add(cpu.registers.A, gameboy::mmu::read(cpu.HL()));
            return 8;
        }
        case 0x87: { // ADD A,A
        ...
        case 0x8E: { // ADC A,(HL)
            cpu.registers.A = adc(cpu.registers.A, gameboy::mmu::read(cpu.HL()));
            return 8;
        }
        case 0x8F: { // ADC A,A
        ...
        case 0x96: { // SUB (HL)
            cpu.registers.A = sub(cpu.registers.A, gameboy::mmu::read(cpu.HL()));
            return 8;
        }
        case 0x97: { // SUB A
        ...
        case 0x9E: { // SBC A,(HL)
            cpu.registers.A = sbc(cpu.registers.A, gameboy::mmu::read(cpu.HL()));
            return 8;
        }
        case 0x9F: { // SBC A,A
        ...
        case 0xA6: { // AND (HL)
            cpu.registers.A = and_(cpu.registers.A, gameboy::mmu::read(cpu.HL()));
            return 8;
        }
        case 0xA7: { // AND A
        ...
        case 0xAE: { // XOR (HL)
            cpu.registers.A = xor_(cpu.registers.A, gameboy::mmu::read(cpu.HL()));
            return 8;
        }
        case 0xAF: { // XOR A
        ...
        case 0xB6: { // OR (HL)
            cpu.registers.A = or_(cpu.registers.A, gameboy::mmu::read(cpu.HL()));
            return 8;
        }
        case 0xB7: { // OR A
        ...
        case 0xBE: { // CP (HL)
            cp(cpu.registers.A, gameboy::mmu::read(cpu.HL()));
            return 8;
        }
        case 0xBF: { // CP A
        ...
        case 0xC6: { // ADD A,d8
            cpu.registers.A = add(cpu.registers.A, gameboy::mmu::read(cpu.program_counter++));
            return 8;
        }
        case 0xC7: { // RST 0x0
            push(cpu.program_counter);
        ...
        case 0xCE: { // ADC A,d8
            cpu.registers.A = adc(cpu.registers.A, gameboy::mmu::read(cpu.program_counter++));
            return 8;
        }
        case 0xCF: { // RST 0x8
            push(cpu.program_counter);
        ...
        case 0xD6: { // SUB d8
            cpu.registers.A = sub(cpu.registers.A, gameboy::mmu::read(cpu.program_counter++));
            return 8;
        }
        case 0xD7: { // RST 0x10
            push(cpu.program_counter);
        ...
        case 0xDE: { // SBC A,d8
            cpu.registers.A = sbc(cpu.registers.A, gameboy::mmu::read(cpu.program_counter++));
            return 8;
        }
        case 0xDF: { // RST 0x18
            push(cpu.program_counter);
        ...
        // 0xE0
        case 0xE0: { // LDH (a8),A
            uint8_t addr = gameboy::mmu::read(cpu.program_counter++);
            gameboy::mmu::write(0xFF00 + addr, cpu.registers.A);
            return 12;
        }
        case 0xE1: { // POP HL
            cpu.set_HL(pop());
        ...
        case 0xE2: { // LD (C),A
            gameboy::mmu::write(0xFF00 + cpu.registers.C, cpu.registers.A);
            return 8;
        }
        case 0xE3: { // Unused
            return 4;
        ...
        case 0xE6: { // AND d8
            cpu.registers.A = and_(cpu.registers.A, gameboy::mmu::read(cpu.program_counter++));
            return 8;
        }
        case 0xE7: { // RST 0x20
            push(cpu.program_counter);
        ...
        case 0xE8: { // ADD SP,r8
            int8_t val = static_cast<int8_t>(gameboy::mmu::read(cpu.program_counter++));
        ...
        case 0xEA: { // LD (a16),A
            ...
            uint8_t high = gameboy::mmu::read(cpu.program_counter++);
            uint16_t addr = (high << 8) | low;
            gameboy::mmu::write(addr, cpu.registers.A);
            return 16;
        }
        case 0xEB: { // Unused
            return 4;
        ...
        case 0xEE: { // XOR d8
            cpu.registers.A = xor_(cpu.registers.A, gameboy::mmu::read(cpu.program_counter++));
            return 8;
        }
        case 0xEF: { // RST 0x28
            push(cpu.program_counter);
        ...
        case 0xF0: { // LDH A,(a8)
            uint8_t addr = gameboy::mmu::read(cpu.program_counter++);
            cpu.registers.A = gameboy::mmu::read(0xFF00 + addr);
            return 12;
        }
        case 0xF1: { // POP AF
            cpu.set_AF(pop());
        ...
        case 0xF2: { // LD A,(C)
            cpu.registers.A = gameboy::mmu::read(0xFF00 + cpu.registers.C);
            return 8;
        }
        case 0xF3: { // DI
        ...
        case 0xF6: { // OR d8
            cpu.registers.A = or_(cpu.registers.A, gameboy::mmu::read(cpu.program_counter++));
            return 8;
        }
        case 0xF7: { // RST 0x30
            push(cpu.program_counter);
        ...
        case 0xF8: { // LD HL,SP+r8
            int8_t val = static_cast<int8_t>(gameboy::mmu::read(cpu.program_counter++));
            uint16_t res = cpu.stack_pointer + val;
            cpu.set_flag_Z(false);
            cpu.set_flag_N(false);
            cpu.set_flag_H((cpu.stack_pointer & 0xF) + (val & 0xF) > 0xF);
            cpu.set_flag_C((cpu.stack_pointer & 0xFF) + (val & 0xFF) > 0xFF);
        ...
        case 0xFA: { // LD A,(a16)
            ...
            uint8_t high = gameboy::mmu::read(cpu.program_counter++);
            uint16_t addr = (high << 8) | low;
            cpu.registers.A = gameboy::mmu::read(addr);
            return 16;
        }
        case 0xFB: { // EI
            cpu.interrupt_master_enable = true;
        ...
        case 0xFE: { // CP d8
            cp(cpu.registers.A, gameboy::mmu::read(cpu.program_counter++));
            return 8;
        }
        case 0xFF: { // RST 0x38
            push(cpu.program_counter);
