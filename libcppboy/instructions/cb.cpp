...
inline uint8_t bit(uint8_t value, uint8_t i) {
...
uint8_t execute(uint8_t opcode) {
    switch (opcode) {
        // 0x00 - RLC operations
        case 0x00: { cpu.registers.B = rlc(cpu.registers.B); return 8; }
        case 0x01: { cpu.registers.C = rlc(cpu.registers.C); return 8; }
        case 0x02: { cpu.registers.D = rlc(cpu.registers.D); return 8; }
        case 0x03: { cpu.registers.E = rlc(cpu.registers.E); return 8; }
        case 0x04: { cpu.registers.H = rlc(cpu.registers.H); return 8; }
        case 0x05: { cpu.registers.L = rlc(cpu.registers.L); return 8; }
        case 0x06: { gameboy::mmu::write(cpu.HL(), rlc(gameboy::mmu::read(cpu.HL()))); return 16; }
        case 0x07: { cpu.registers.A = rlc(cpu.registers.A); return 8; }
        
        // 0x08 - RRC operations
        case 0x08: { cpu.registers.B = rrc(cpu.registers.B); return 8; }
        case 0x09: { cpu.registers.C = rrc(cpu.registers.C); return 8; }
        case 0x0A: { cpu.registers.D = rrc(cpu.registers.D); return 8; }
        case 0x0B: { cpu.registers.E = rrc(cpu.registers.E); return 8; }
        case 0x0C: { cpu.registers.H = rrc(cpu.registers.H); return 8; }
        case 0x0D: { cpu.registers.L = rrc(cpu.registers.L); return 8; }
        case 0x0E: { gameboy::mmu::write(cpu.HL(), rrc(gameboy::mmu::read(cpu.HL()))); return 16; }
        case 0x0F: { cpu.registers.A = rrc(cpu.registers.A); return 8; }
        
        // 0x10 - RL operations
        case 0x10: { cpu.registers.B = rl(cpu.registers.B); return 8; }
        case 0x11: { cpu.registers.C = rl(cpu.registers.C); return 8; }
        case 0x12: { cpu.registers.D = rl(cpu.registers.D); return 8; }
        case 0x13: { cpu.registers.E = rl(cpu.registers.E); return 8; }
        case 0x14: { cpu.registers.H = rl(cpu.registers.H); return 8; }
        case 0x15: { cpu.registers.L = rl(cpu.registers.L); return 8; }
        case 0x16: { gameboy::mmu::write(cpu.HL(), rl(gameboy::mmu::read(cpu.HL()))); return 16; }
        case 0x17: { cpu.registers.A = rl(cpu.registers.A); return 8; }
        
        // 0x18 - RR operations
        case 0x18: { cpu.registers.B = rr(cpu.registers.B); return 8; }
        case 0x19: { cpu.registers.C = rr(cpu.registers.C); return 8; }
        case 0x1A: { cpu.registers.D = rr(cpu.registers.D); return 8; }
        case 0x1B: { cpu.registers.E = rr(cpu.registers.E); return 8; }
        case 0x1C: { cpu.registers.H = rr(cpu.registers.H); return 8; }
        case 0x1D: { cpu.registers.L = rr(cpu.registers.L); return 8; }
        case 0x1E: { gameboy::mmu::write(cpu.HL(), rr(gameboy::mmu::read(cpu.HL()))); return 16; }
        case 0x1F: { cpu.registers.A = rr(cpu.registers.A); return 8; }
        
        // 0x20 - SLA operations
        case 0x20: { cpu.registers.B = sla(cpu.registers.B); return 8; }
        case 0x21: { cpu.registers.C = sla(cpu.registers.C); return 8; }
        case 0x22: { cpu.registers.D = sla(cpu.registers.D); return 8; }
        case 0x23: { cpu.registers.E = sla(cpu.registers.E); return 8; }
        case 0x24: { cpu.registers.H = sla(cpu.registers.H); return 8; }
        case 0x25: { cpu.registers.L = sla(cpu.registers.L); return 8; }
        case 0x26: { gameboy::mmu::write(cpu.HL(), sla(gameboy::mmu::read(cpu.HL()))); return 16; }
        case 0x27: { cpu.registers.A = sla(cpu.registers.A); return 8; }
        
        // 0x28 - SRA operations
        case 0x28: { cpu.registers.B = sra(cpu.registers.B); return 8; }
        case 0x29: { cpu.registers.C = sra(cpu.registers.C); return 8; }
        case 0x2A: { cpu.registers.D = sra(cpu.registers.D); return 8; }
        case 0x2B: { cpu.registers.E = sra(cpu.registers.E); return 8; }
        case 0x2C: { cpu.registers.H = sra(cpu.registers.H); return 8; }
        case 0x2D: { cpu.registers.L = sra(cpu.registers.L); return 8; }
        case 0x2E: { gameboy::mmu::write(cpu.HL(), sra(gameboy::mmu::read(cpu.HL()))); return 16; }
        case 0x2F: { cpu.registers.A = sra(cpu.registers.A); return 8; }
        
        // 0x30 - SWAP operations
        case 0x30: { cpu.registers.B = swap(cpu.registers.B); return 8; }
        case 0x31: { cpu.registers.C = swap(cpu.registers.C); return 8; }
        case 0x32: { cpu.registers.D = swap(cpu.registers.D); return 8; }
        case 0x33: { cpu.registers.E = swap(cpu.registers.E); return 8; }
        case 0x34: { cpu.registers.H = swap(cpu.registers.H); return 8; }
        case 0x35: { cpu.registers.L = swap(cpu.registers.L); return 8; }
        case 0x36: { gameboy::mmu::write(cpu.HL(), swap(gameboy::mmu::read(cpu.HL()))); return 16; }
        case 0x37: { cpu.registers.A = swap(cpu.registers.A); return 8; }
        
        // 0x38 - SRL operations
        case 0x38: { cpu.registers.B = srl(cpu.registers.B); return 8; }
        case 0x39: { cpu.registers.C = srl(cpu.registers.C); return 8; }
        case 0x3A: { cpu.registers.D = srl(cpu.registers.D); return 8; }
        case 0x3B: { cpu.registers.E = srl(cpu.registers.E); return 8; }
        case 0x3C: { cpu.registers.H = srl(cpu.registers.H); return 8; }
        case 0x3D: { cpu.registers.L = srl(cpu.registers.L); return 8; }
        case 0x3E: { gameboy::mmu::write(cpu.HL(), srl(gameboy::mmu::read(cpu.HL()))); return 16; }
        case 0x3F: { cpu.registers.A = srl(cpu.registers.A); return 8; }
        
        // 0x40 - BIT 0 operations
        case 0x40: { bit(cpu.registers.B, 0); return 8; }
        case 0x41: { bit(cpu.registers.C, 0); return 8; }
        case 0x42: { bit(cpu.registers.D, 0); return 8; }
        case 0x43: { bit(cpu.registers.E, 0); return 8; }
        case 0x44: { bit(cpu.registers.H, 0); return 8; }
        case 0x45: { bit(cpu.registers.L, 0); return 8; }
        case 0x46: { bit(gameboy::mmu::read(cpu.HL()), 0); return 12; }
        case 0x47: { bit(cpu.registers.A, 0); return 8; }
        
        // 0x48 - BIT 1 operations
        case 0x48: { bit(cpu.registers.B, 1); return 8; }
        case 0x49: { bit(cpu.registers.C, 1); return 8; }
        case 0x4A: { bit(cpu.registers.D, 1); return 8; }
        case 0x4B: { bit(cpu.registers.E, 1); return 8; }
        case 0x4C: { bit(cpu.registers.H, 1); return 8; }
        case 0x4D: { bit(cpu.registers.L, 1); return 8; }
        case 0x4E: { bit(gameboy::mmu::read(cpu.HL()), 1); return 12; }
        case 0x4F: { bit(cpu.registers.A, 1); return 8; }
        
        // 0x50 - BIT 2 operations
        case 0x50: { bit(cpu.registers.B, 2); return 8; }
        case 0x51: { bit(cpu.registers.C, 2); return 8; }
        case 0x52: { bit(cpu.registers.D, 2); return 8; }
        case 0x53: { bit(cpu.registers.E, 2); return 8; }
        case 0x54: { bit(cpu.registers.H, 2); return 8; }
        case 0x55: { bit(cpu.registers.L, 2); return 8; }
        case 0x56: { bit(gameboy::mmu::read(cpu.HL()), 2); return 12; }
        case 0x57: { bit(cpu.registers.A, 2); return 8; }
        
        // 0x58 - BIT 3 operations
        case 0x58: { bit(cpu.registers.B, 3); return 8; }
        case 0x59: { bit(cpu.registers.C, 3); return 8; }
        case 0x5A: { bit(cpu.registers.D, 3); return 8; }
        case 0x5B: { bit(cpu.registers.E, 3); return 8; }
        case 0x5C: { bit(cpu.registers.H, 3); return 8; }
        case 0x5D: { bit(cpu.registers.L, 3); return 8; }
        case 0x5E: { bit(gameboy::mmu::read(cpu.HL()), 3); return 12; }
        case 0x5F: { bit(cpu.registers.A, 3); return 8; }
        
        // 0x60 - BIT 4 operations
        case 0x60: { bit(cpu.registers.B, 4); return 8; }
        case 0x61: { bit(cpu.registers.C, 4); return 8; }
        case 0x62: { bit(cpu.registers.D, 4); return 8; }
        case 0x63: { bit(cpu.registers.E, 4); return 8; }
        case 0x64: { bit(cpu.registers.H, 4); return 8; }
        case 0x65: { bit(cpu.registers.L, 4); return 8; }
        case 0x66: { bit(gameboy::mmu::read(cpu.HL()), 4); return 12; }
        case 0x67: { bit(cpu.registers.A, 4); return 8; }
        
        // 0x68 - BIT 5 operations
        case 0x68: { bit(cpu.registers.B, 5); return 8; }
        case 0x69: { bit(cpu.registers.C, 5); return 8; }
        case 0x6A: { bit(cpu.registers.D, 5); return 8; }
        case 0x6B: { bit(cpu.registers.E, 5); return 8; }
        case 0x6C: { bit(cpu.registers.H, 5); return 8; }
        case 0x6D: { bit(cpu.registers.L, 5); return 8; }
        case 0x6E: { bit(gameboy::mmu::read(cpu.HL()), 5); return 12; }
        case 0x6F: { bit(cpu.registers.A, 5); return 8; }
        
        // 0x70 - BIT 6 operations
        case 0x70: { bit(cpu.registers.B, 6); return 8; }
        case 0x71: { bit(cpu.registers.C, 6); return 8; }
        case 0x72: { bit(cpu.registers.D, 6); return 8; }
        case 0x73: { bit(cpu.registers.E, 6); return 8; }
        case 0x74: { bit(cpu.registers.H, 6); return 8; }
        case 0x75: { bit(cpu.registers.L, 6); return 8; }
        case 0x76: { bit(gameboy::mmu::read(cpu.HL()), 6); return 12; }
        case 0x77: { bit(cpu.registers.A, 6); return 8; }
        
        // 0x78 - BIT 7 operations
        case 0x78: { bit(cpu.registers.B, 7); return 8; }
        case 0x79: { bit(cpu.registers.C, 7); return 8; }
        case 0x7A: { bit(cpu.registers.D, 7); return 8; }
        case 0x7B: { bit(cpu.registers.E, 7); return 8; }
        case 0x7C: { bit(cpu.registers.H, 7); return 8; }
        case 0x7D: { bit(cpu.registers.L, 7); return 8; }
        case 0x7E: { bit(gameboy::mmu::read(cpu.HL()), 7); return 12; }
        case 0x7F: { bit(cpu.registers.A, 7); return 8; }
        ...
        case 0x86: { gameboy::mmu::write(cpu.HL(), res(gameboy::mmu::read(cpu.HL()), 0)); return 16; }
        ...
        case 0x8E: { gameboy::mmu::write(cpu.HL(), res(gameboy::mmu::read(cpu.HL()), 1)); return 16; }
        ...
        case 0x96: { gameboy::mmu::write(cpu.HL(), res(gameboy::mmu::read(cpu.HL()), 2)); return 16; }
        ...
        case 0x9E: { gameboy::mmu::write(cpu.HL(), res(gameboy::mmu::read(cpu.HL()), 3)); return 16; }
        ...
        case 0xA6: { gameboy::mmu::write(cpu.HL(), res(gameboy::mmu::read(cpu.HL()), 4)); return 16; }
        ...
        case 0xAE: { gameboy::mmu::write(cpu.HL(), res(gameboy::mmu::read(cpu.HL()), 5)); return 16; }
        ...
        case 0xB6: { gameboy::mmu::write(cpu.HL(), res(gameboy::mmu::read(cpu.HL()), 6)); return 16; }
        ...
        case 0xBE: { gameboy::mmu::write(cpu.HL(), res(gameboy::mmu::read(cpu.HL()), 7)); return 16; }
        ...
        case 0xC6: { gameboy::mmu::write(cpu.HL(), set(gameboy::mmu::read(cpu.HL()), 0)); return 16; }
        ...
        case 0xCE: { gameboy::mmu::write(cpu.HL(), set(gameboy::mmu::read(cpu.HL()), 1)); return 16; }
        ...
        case 0xD6: { gameboy::mmu::write(cpu.HL(), set(gameboy::mmu::read(cpu.HL()), 2)); return 16; }
        ...
        case 0xDE: { gameboy::mmu::write(cpu.HL(), set(gameboy::mmu::read(cpu.HL()), 3)); return 16; }
        ...
        case 0xE6: { gameboy::mmu::write(cpu.HL(), set(gameboy::mmu::read(cpu.HL()), 4)); return 16; }
        ...
        case 0xEE: { gameboy::mmu::write(cpu.HL(), set(gameboy::mmu::read(cpu.HL()), 5)); return 16; }
        ...
        case 0xF6: { gameboy::mmu::write(cpu.HL(), set(gameboy::mmu::read(cpu.HL()), 6)); return 16; }
        ...
        case 0xFE: { gameboy::mmu::write(cpu.HL(), set(gameboy::mmu::read(cpu.HL()), 7)); return 16; }
